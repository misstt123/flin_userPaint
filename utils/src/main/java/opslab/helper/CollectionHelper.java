...
import opslab.functions.ObjectHander;
import opslab.functions.ObjectProcess;
...
public class CollectionHelper {
    ...
    /**
     * @return void
     * @author lyh-god on 2020/4/30
     * @Description: 对集合中元素进行特定的处理
     */
    public static <T> void handler(Collection<T> collection, ObjectHander<T> hander) {
     ...
     * @return void
     * @author lyh-god on 2020/4/30
     * @Description: 对集合中的元素进行特定的处理，并获得处理后的结果
     */
     ...
     * @Description: 去除元素
     */
    public static<T> List<T> removeDublicate(List<T> list) {
