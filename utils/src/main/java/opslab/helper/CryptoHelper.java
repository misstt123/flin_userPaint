...
import opslab.util.encrypt.ASEUtil;
import opslab.util.encrypt.Base64Ext;
import opslab.util.encrypt.DESUtil;
import opslab.util.encrypt.Decode;
...
public class CryptoHelper {
     ...
     * @return string
     */
    public static String aesEncrypt(String secretKey, String str) throws NoSuchPaddingException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, UnsupportedEncodingException, InvalidKeyException {
     ...
     */
    public static String aseDecode(String secretKey, String str) throws UnsupportedEncodingException {
